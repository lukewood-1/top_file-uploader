...
FIX: fix createFolder function
FIX: fix currentFolder property
FEAT: Add 'back to parent' button where it either shows the folder's parent folder or it does not appear on the UI
